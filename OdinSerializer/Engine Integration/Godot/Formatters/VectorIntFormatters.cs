...
[assembly: RegisterFormatter(typeof(Vector4IntFormatter))]
...
namespace OdinSerializer
{
    ...
    /// </summary>
    /// <seealso cref="MinimalBaseFormatter{Vector2I}" />
    ...
    /// </summary>
    /// <seealso cref="MinimalBaseFormatter{Vector3I}" />
    ...
    /// <summary>
    /// Custom formatter for the <see cref="Vector4I"/> type.
    /// </summary>
    /// <seealso cref="MinimalBaseFormatter{Vector4I}" />
    public class Vector4IntFormatter : MinimalBaseFormatter<Vector4I>
    {
        private static readonly Serializer<int> Serializer = OdinSerializer.Serializer.Get<int>();
        ...
        /// <param name="value">The value to read into.</param>
        /// <param name="reader">The reader to use.</param>
        protected override void Read(ref Vector4I value, IDataReader reader)
        {
            value.X = Serializer.ReadValue(reader);
            value.Y = Serializer.ReadValue(reader);
            value.Z = Serializer.ReadValue(reader);
        ...
        /// <param name="value">The value to write from.</param>
        /// <param name="writer">The writer to use.</param>
        protected override void Write(ref Vector4I value, IDataWriter writer)
        {
            Serializer.WriteValue(value.X, writer);
            Serializer.WriteValue(value.Y, writer);
            Serializer.WriteValue(value.Z, writer);
