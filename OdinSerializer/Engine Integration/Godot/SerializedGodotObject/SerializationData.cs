...
using OdinSerializer.Utilities.Wrapper;
...
namespace OdinSerializer
{
    ...
    /// <summary>
    /// Godot serialized data struct that contains all data needed by Odin serialization.
    /// </summary>
    [Serializable]
    public struct SerializationData
    {
        ...
        /// when the Godot object gets serialized, unless the Godot object implements the <see cref="IOverridesSerializationFormat"/> interface.
        /// </summary>
        [SerializeField]
        ...
        /// <summary>
        /// All serialized Godot references.
        /// </summary>
        [SerializeField]
        public List<Godot.GodotObject> ReferencedGodotObjects;
        ...
        /// If this is false, then it could mean that Godot has not yet deserialized the struct.
        /// </summary>
        public bool ContainsData
        {
            get
            {
                return
                    ...
                    this.ReferencedGodotObjects != null;
            }
        }
        ...
        /// </summary>
        [SerializeField]
        public Godot.GodotObject Prefab;

        /// <summary>
        /// All serialized Godot references.
        /// </summary>
        [SerializeField]
        public List<Godot.GodotObject> PrefabModificationsReferencedUnityObjects;
        ...
        public void Reset()
        {
            ...
            if (this.ReferencedGodotObjects != null && this.ReferencedGodotObjects.Count > 0)
            {
                this.ReferencedGodotObjects.Clear();
            }
